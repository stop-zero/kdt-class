...
// cookieParser(secreatKey, optionOjb);
// - secretKey : 비밀키,
...
// 3. 쿠키 삭제
app.get('document.getElementById("cookie").checked', (req, res) => {
  //쿠키 삭제
  // clearCookie 할 때, res.cookie() 설정했던 key & vlaue & option 일치해야 함
  //(단, option 에서 expires, maxAge 옵션은 일치하지 않아도 괜찮!)
